...
export const SCENARIO = {
  ...
  minorIndicators: { gdp: 10, industry: 10, resources: 30, army: 10, navy: 3, air: 5, manpower: 1, stability: 60, war_support: 20 },
  ...
  nations: {
    GER: { name: 'Germany',        leader: 'Adolf Hitler',           ideology: 'Nazi dictatorship',        faction: 'Axis',      color: '#6e7479', home: 'Germany',                  playable: true,  indicators: { gdp: 412, industry: 85, resources: 40, army: 85, navy: 35, air: 80, manpower: 10, stability: 75, war_support: 60 } },
    ITA: { name: 'Italy',          leader: 'Benito Mussolini',       ideology: 'Fascist dictatorship',     faction: 'Axis',      color: '#5f8a3a', home: 'Italy',                    playable: true,  indicators: { gdp: 151, industry: 45, resources: 25, army: 45, navy: 55, air: 45, manpower: 5, stability: 60, war_support: 35 } },
    JAP: { name: 'Japan',          leader: 'Nobuyuki Abe (Prime Minister)', ideology: 'Militarist empire', faction: 'Axis',      color: '#d9b44a', home: 'Japan',                    playable: true,  indicators: { gdp: 196, industry: 55, resources: 20, army: 60, navy: 80, air: 60, manpower: 7, stability: 70, war_support: 70 } },
    UK:  { name: 'United Kingdom', leader: 'Neville Chamberlain',    ideology: 'Parliamentary democracy',  faction: 'Allies',    color: '#d98c9a', home: 'United Kingdom',           playable: true,  indicators: { gdp: 287, industry: 70, resources: 60, army: 35, navy: 95, air: 60, manpower: 6, stability: 80, war_support: 55 } },
    FRA: { name: 'France',         leader: 'Édouard Daladier',       ideology: 'Parliamentary democracy',  faction: 'Allies',    color: '#4f7cc4', home: 'France',                   playable: true,  indicators: { gdp: 199, industry: 55, resources: 45, army: 70, navy: 60, air: 40, manpower: 6, stability: 55, war_support: 40 } },
    USA: { name: 'United States',  leader: 'Franklin D. Roosevelt',  ideology: 'Presidential democracy',   faction: null,        color: '#6fa08c', home: 'United States',            playable: true,  indicators: { gdp: 869, industry: 95, resources: 90, army: 20, navy: 70, air: 35, manpower: 12, stability: 80, war_support: 15 } },
    SOV: { name: 'Soviet Union',   leader: 'Joseph Stalin',          ideology: 'Communist dictatorship',   faction: 'Comintern', color: '#9e2b25', home: 'European Russia',          playable: true,  indicators: { gdp: 366, industry: 70, resources: 90, army: 75, navy: 30, air: 65, manpower: 20, stability: 60, war_support: 55 } },
    CHN: { name: 'China',          leader: 'Chiang Kai-shek',        ideology: 'Nationalist one-party state', faction: null,     color: '#e0a15a', home: 'Southwest China',          playable: true,  indicators: { gdp: 288, industry: 15, resources: 50, army: 45, navy: 5, air: 10, manpower: 30, stability: 35, war_support: 75 } },
    POL: { name: 'Poland',         leader: 'Ignacy Mościcki (President)', ideology: 'Authoritarian republic', faction: 'Allies', color: '#b9a3d6', home: 'Poland',                   playable: true,  indicators: { gdp: 76, industry: 25, resources: 30, army: 45, navy: 10, air: 25, manpower: 3, stability: 65, war_support: 85 } },

    CAN: { name: 'Canada',         leader: 'W. L. Mackenzie King',   ideology: 'Parliamentary democracy',  faction: null,        color: '#c7707f', home: 'Canada',        indicators: { gdp: 40, industry: 30, resources: 70, army: 10, navy: 15, air: 10, manpower: 2, stability: 80, war_support: 40 } },
    AUS: { name: 'Australia',      leader: 'Robert Menzies',         ideology: 'Parliamentary democracy',  faction: null,        color: '#cf8f7a', home: 'Australia',     indicators: { gdp: 24, industry: 20, resources: 70, army: 10, navy: 15, air: 10, manpower: 1, stability: 80, war_support: 45 } },
    NZL: { name: 'New Zealand',    leader: 'Michael Joseph Savage',  ideology: 'Parliamentary democracy',  faction: null,        color: '#b5767e', home: 'New Zealand',   indicators: { gdp: 9, industry: 10, resources: 40, army: 5, navy: 5, air: 5, manpower: 0.3, stability: 80, war_support: 45 } },
    SAF: { name: 'South Africa',   leader: 'J. B. M. Hertzog',       ideology: 'Parliamentary democracy',  faction: null,        color: '#a86a55', home: 'South Africa',  indicators: { gdp: 15, industry: 15, resources: 60, army: 8, navy: 3, air: 5, manpower: 0.5, stability: 60, war_support: 30 } },
    NED: { name: 'Netherlands',    leader: 'Dirk Jan de Geer',       ideology: 'Constitutional monarchy',  faction: null,        color: '#e08a3c', home: 'Netherlands',   indicators: { gdp: 52, industry: 30, resources: 50, army: 15, navy: 25, air: 10, manpower: 1, stability: 75, war_support: 20 } },
    BEL: { name: 'Belgium',        leader: 'Hubert Pierlot',         ideology: 'Constitutional monarchy',  faction: null,        color: '#c9b458', home: 'Belgium',       indicators: { gdp: 40, industry: 30, resources: 45, army: 20, navy: 3, air: 10, manpower: 1, stability: 70, war_support: 25 } },
    POR: { name: 'Portugal',       leader: 'António Salazar',        ideology: 'Authoritarian Estado Novo', faction: null,       color: '#3f8f6b', home: 'Portugal',      indicators: { gdp: 15, industry: 10, resources: 40, army: 10, navy: 10, air: 5, manpower: 1, stability: 70, war_support: 15 } },
    SPA: { name: 'Spain',          leader: 'Francisco Franco',       ideology: 'Nationalist dictatorship', faction: null,        color: '#c9a64a', home: 'Spain',         indicators: { gdp: 40, industry: 15, resources: 35, army: 35, navy: 15, air: 15, manpower: 3, stability: 45, war_support: 10 } },
    ROM: { name: 'Romania',        leader: 'King Carol II',          ideology: 'Royal dictatorship',       faction: null,        color: '#c9c06a', home: 'Romania',       indicators: { gdp: 20, industry: 12, resources: 60, army: 30, navy: 3, air: 10, manpower: 2, stability: 45, war_support: 30 } },
    YUG: { name: 'Yugoslavia',     leader: 'Prince Paul (Regent)',   ideology: 'Monarchy',                 faction: null,        color: '#8a86b8', home: 'Yugoslavia',    indicators: { gdp: 22, industry: 10, resources: 40, army: 30, navy: 5, air: 10, manpower: 2, stability: 40, war_support: 30 } },
    SVK: { name: 'Slovakia',       leader: 'Jozef Tiso',             ideology: 'Clerical-fascist client state', faction: null,   color: '#8f949a', home: 'Slovakia',      indicators: { gdp: 6, industry: 8, resources: 20, army: 10, navy: 0, air: 3, manpower: 0.5, stability: 50, war_support: 30 } },
    DEN: { name: 'Denmark',        leader: 'Thorvald Stauning',      ideology: 'Constitutional monarchy',  faction: null,        color: '#b0555f', home: 'Denmark',       indicators: { gdp: 18, industry: 20, resources: 30, army: 5, navy: 5, air: 3, manpower: 0.3, stability: 80, war_support: 10 } },
    FIN: { name: 'Finland',        leader: 'Kyösti Kallio (President)', ideology: 'Parliamentary republic', faction: null,      color: '#dfe3e8', home: 'Finland',       indicators: { gdp: 12, industry: 15, resources: 30, army: 25, navy: 3, air: 5, manpower: 0.4, stability: 80, war_support: 60 } },
    HUN: { name: 'Hungary',        leader: 'Miklós Horthy (Regent)', ideology: 'Authoritarian kingdom',  faction: null,        color: '#a8b38a', home: 'Hungary',       indicators: { gdp: 24, industry: 15, resources: 30, army: 20, navy: 0, air: 8, manpower: 1.5, stability: 60, war_support: 40 } },
    MAN: { name: 'Manchukuo',      leader: 'Puyi (puppet emperor)',  ideology: 'Japanese puppet state',    faction: 'Axis',      color: '#e6cf86', home: 'Manchukuo',     indicators: { gdp: 30, industry: 25, resources: 50, army: 15, navy: 0, air: 5, manpower: 3, stability: 40, war_support: 20 } },
    EGY: { name: 'Egypt',          leader: 'King Farouk',            ideology: 'Monarchy (British influence)', faction: null,    color: '#d8c38e', home: 'Egypt',         indicators: { gdp: 20, industry: 8, resources: 30, army: 5, navy: 1, air: 2, manpower: 1, stability: 50, war_support: 20 } },
    MON: { name: 'Mongolia',       leader: 'Khorloogiin Choibalsan', ideology: 'Communist (Soviet-aligned)', faction: 'Comintern', color: '#b8574d', home: 'Mongolia', indicators: { gdp: 1, industry: 2, resources: 20, army: 10, navy: 0, air: 2, manpower: 0.1, stability: 60, war_support: 60 } }
  },
